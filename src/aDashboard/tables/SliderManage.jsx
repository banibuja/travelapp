...
function SliderManage() {
    ...
    reader.onload = async () => {
      ...
      try {
        const response = await axios.post(
          'http://localhost:5001/api/add-images',
  ...
  const deleteImage = async (id) => {
    try {
      await axios.delete(`http://localhost:5001/api/images-delete/${id}`, {
        withCredentials: true,
      });
          ...
          <div className="px-8 py-6" style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #2d5a87 100%)' }}>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">Home Slider</h2>
            ...
            <div className="mx-8 mt-6 p-6 bg-gray-50 rounded-xl border border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end space-x-2">
                  ...
                  <button onClick={addImage} className="px-6 py-2 rounded-xl text-white font-semibold" style={{ background: 'linear-gradient(135deg, #10b981, #34d399)' }}>Add</button>
                </div>
              </div>
            </div>
          )}
