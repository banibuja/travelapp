      ...
      <div className="relative z-10 w-full max-w-2xl mx-4">
        ...
        >
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-white mb-2">Kontaktoni me Ne</h2>
            <p className="text-cyan-200 text-sm">Na dërgoni një mesazh dhe ne do t'ju përgjigjemi sa më shpejt</p>
          </div>
