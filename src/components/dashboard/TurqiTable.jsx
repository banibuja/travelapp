...
function ManageRoomPricesTable() {
  ...
  const deleteRoomPrice = async (id) => {
    try {
      await axios.delete(`http://localhost:5000/room-prices-delete/${id}`, {
        withCredentials: true,
      });
  ...
  const updateRoomPrice = async (id) => {
    ...
    try {
      const response = await axios.put(`http://localhost:5000/room-prices-update/${id}`, updatedPrice, {
        withCredentials: true,
      });
      setRoomPrices(
  ...
  const addRoomPrice = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/add-room-price', newPrice, {
        withCredentials: true,
      });
