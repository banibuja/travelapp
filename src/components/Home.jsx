...
function Home() {
  ...
  return (
    <div>
      ...
      <div class="flex justify-center items-center space-x-4 p-5 mt-[2rem]">
    <div class="check flex items-center bg-gray-100 rounded-lg shadow-md p-2">
  ...
  <div className="flex flex-col justify-center items-center p-10">
     <div className="flex justify-center items-center space-x-4 p-10 mx-auto truncate whitespace-break-spaces text-navy text-xl font-bold tracking-tight lg:text-2xl"> 
      <span>Oferta Speciale</span> </div> 
      <div className="group">
        
         <img className="w-[70rem] h-[450px] rounded-lg object-cover transition-transform duration-300 group-hover:scale-110" src="https://images.ctfassets.net/pzootm7d2s0g/1h4IWXmTcNR9ZHzw4EX1ti/16b41707c8b54e1ad9fd569a4ae9597e/p0j759k4.jpg" alt="Oferta Speciale" /> </div> </div>
...
<div className="grid  grid-cols-2 gap-4 justify-center items-center ml-[19.1rem] py-3">
  <div className="im1 group">
  <img
    className="w-[500px] h-auto rounded-lg object-cover transition-all group-hover:scale-110"
...
<div className="f p-10">
      ...
      <div className="subscription bg-gray-100 p-6 rounded-lg text-center">
